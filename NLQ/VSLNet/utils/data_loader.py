...
def make_train_collate_fn(extend):
    def train_collate_fn(data):
        ...
        # extend = 0.1    # alpha hyperparameter in the original paper (not hard coded)
...
def test_collate_fn(data):
    # Same logic as train_collate_fn, but do not build highlighter labels
...
def get_train_loader(dataset, video_features, configs):
    ...
    collate_fn = make_train_collate_fn(extend=extend)
